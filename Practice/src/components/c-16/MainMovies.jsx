...
<form >
    <div className='search-btn'>
        <input type="text" placeholder='Enter the movie name' className='inputText' value={search}
   ...
   ( filteredMovies.length===0 ) ? <p className='notfound'>NOT FOUND</p> :   filteredMovies.map((item,index)=>(

    <MovieCards  {...item} key={index} />
